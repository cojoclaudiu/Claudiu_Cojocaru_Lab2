...
public class BookCategoriesPageModel : PageModel
{
    ...
    public void PopulateAssignedCategoryData(Claudiu_Cojocaru_Lab2Context context, Book book)
    {
    ...
    public void UpdateBookCategories(Claudiu_Cojocaru_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
    {
